...
async def categories_handler(request: Request):
    """GET /categories -> return available categories for filtering."""
    return JSONResponse({
        "ok": True,
        "categories": ["policies", "faqs", "guides", "handbooks", "announcements"]
    })
...
async def ask_handler(request: Request):
    ...
    # Optional: category to scope retrieval (None means all categories)
...
# Categories
app.router.add_route("/categories", categories_handler, methods=["GET"])
# RAG API
